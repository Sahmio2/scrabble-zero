...
export default function GamePage() {
  ...
  // Derive board and rack based on game mode
  const isPractice = currentRoom?.mode === "practice";
  const gameStarted = isPractice ? localGameStarted : serverGameStarted;
  ...
  const isCurrentPlayerTurn = displayPlayers[currentTurn]?.id === currentUserId;
